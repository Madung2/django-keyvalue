...
from .views import extract_key_value, extract_xl, render_tsexpert, save_key_value, render_docGenerator, run_generator, run_generator_data, get_task_status, extract_term_sheet
urlpatterns = [
